        ...
        <View style={styles.container}>
            ...
            <View style={styles.explanationContainer}>
                <Image
                    ...
                    <Text style={styles.description}>
                        <Text style={styles.mind}> Mente: </Text>Hábitos para {"\n"} melhorar sua inteligência/sabedoria  
                    </Text>
            </View>
            ...
            <View style={styles.explanationContainer}>
                <Image
                    ...
                    />
                    <Text style={styles.description}>
                        <Text style={styles.money}> Financeiro: </Text>Hábitos para te {"\n"} ajudar com controle financeiro 
                    </Text>
            </View>
